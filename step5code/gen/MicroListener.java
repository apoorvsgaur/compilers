...
public interface MicroListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MicroParser#var_id}.
	 * @param ctx the parse tree
	 */
	void enterVar_id(MicroParser.Var_idContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#var_id}.
	 * @param ctx the parse tree
	 */
	void exitVar_id(MicroParser.Var_idContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MicroParser#var_id_list}.
	 * @param ctx the parse tree
	 */
	void enterVar_id_list(MicroParser.Var_id_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#var_id_list}.
	 * @param ctx the parse tree
	 */
	void exitVar_id_list(MicroParser.Var_id_listContext ctx);
	/**
	 * Enter a parse tree produced by {@link MicroParser#var_id_tail}.
	 * @param ctx the parse tree
	 */
	void enterVar_id_tail(MicroParser.Var_id_tailContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#var_id_tail}.
	 * @param ctx the parse tree
	 */
	void exitVar_id_tail(MicroParser.Var_id_tailContext ctx);
	/**
